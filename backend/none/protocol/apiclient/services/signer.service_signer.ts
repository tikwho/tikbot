...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ============================ strData ============================
const KEY = 'Dkdpgh4ZKsQB80/Mfvw36XI1R25+WUAlEi7NLboqYTOPuzmFjJnryx9HVGcaStCe=';
const fix_hash = 65599;
const fix_bin = 8240;
const canvas_hash = 536919696;
const userAgentVar = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36";
...
function get_xb(Data, Parame, UA, canvas_hash) {
    var time = new Date().getTime() / 1000;//1679135956//
...
function toBinaryString(v, includeLength) {
    ...
    var result = v.join('');
    console.info(result, v, includeLength, "bbbbbbbbb-------------------------");
    if (includeLength) {
...
export class SignerService {
  ...
  xbogus(params, userAgent , body = null, contentType = null) {
    let bodyStr = "";
    if (contentType === "data") {
    ...
    // console.info(tiktok_mssdk_decode(""),"de---------");
    console.info([bodyStr, params, userAgent|| userAgentVar, canvas_hash]);
    let xb =  get_xb(bodyStr, params, userAgent|| userAgentVar, canvas_hash );
    console.info( xb,"xb---------------------");
  ...
  sign(url, params?:any, userAgent?:string,data?:any,noSign?:any) {
    // if (userAgent) {
    ...
    uri.searchParams.append("X-Bogus", this.xbogus(uri.searchParams.toString(),userAgent,data));
    !noSign && uri.searchParams.append("_signature", this.signature(url)) ;
